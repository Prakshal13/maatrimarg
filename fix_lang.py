...
def insert_before(lines, target, new_lines):
...
# Insert en_faq before "  mr: {"
lines = insert_before(lines, "  mr: {", en_faq)
# Insert mr_faq before "  hi: {"
lines = insert_before(lines, "  hi: {", mr_faq)
# Insert hi_faq before "  ta: {"
lines = insert_before(lines, "  ta: {", hi_faq)
# Insert ta_faq before "};" at the very end (or before the end of ta block)
lines = insert_before(lines, "export const LanguageContext", ta_faq) # actually, it's safer to insert before the last closing brace.
# Let's find the closing brace of ta block.
# Wait, LanguageContext ends with export const LanguageContext = createContext(); 
# So inserting before export const LanguageContext is perfect.
